...
void ARTSPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("ResetVR", IE_Pressed, this, &ARTSPlayerController::OnResetVR);
}

void ARTSPlayerController::OnResetVR()
{
...
void ARTSPlayerController::MoveToMouseCursor()
{
	...
	{
		if (ARTSCharacter* MyPawn = Cast<ARTSCharacter>(GetPawn()))
		{
